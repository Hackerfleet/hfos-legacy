...
Logbook = {
    ...
    'properties': {
        ...
        'time': {'type': 'string', 'format': 'date', 'title': 'Event time', 'description': 'Date and time of event'},
        'category': {'type': 'string', 'title': 'Category', 'enum': ['Incident', 'Navigation', 'Technical', 'Bridge'],
