    ...
    'properties': {
        ...
        'layerOptions': {
            ...
            'maxNativeZoom': {'type': 'number',
                              'description': 'Maximum zoom number the tiles source has available. If it is specified, the tiles on all zoom levels higher than maxNativeZoom will be loaded from maxZoom level and auto-scaled.',
                              'default': 'null'},
            ...
            'bounds': {'type': 'list',
                       'description': 'When this option is set, the TileLayer only loads tiles that are in the given geographical bounds.'}
        }
    }
}
