...
BookSchema = {
    ...
    'properties': {
        ...
        'authors': {
            'type': 'array',
            'default': [],
            'items': {'type': 'string', 'title': 'Authors', 'description': 'Authors of Book'},
            'minItems': 0
        },
        'publisher': {'type': 'string', 'title': 'Publisher', 'description': 'Publisher of Book'},
        'owneruuid': {'type': 'string', 'minLength': 36, 'title': "Owner's Unique ID", 'description': 'HIDDEN'},
        'language': {'type': 'string', 'title': 'Language', 'description': 'Lanuage'},
        'available': {'type': 'boolean', 'title': 'Available', 'description': 'Eligible for lending', 'default': True},
        'status': {'type': 'string', 'title': 'Status', 'description': 'Last known status'},
        'statuschange': {'type': 'string', 'format': 'datetimepicker', 'title': 'Status date',
                         'description': 'Latest status change date'},
        'statusowner': {'type': 'string', 'minLength': 36, 'title': 'Unique User ID',
        ...
        'isbnalt': {'type': 'string', 'title': 'ISBN', 'description': 'Alternative International Standard Book Number',
                    'pattern': '^(97(8|9))?\d{9}(\d|X)$'},
